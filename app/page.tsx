  ...
  return (
    <main style={{
      ...
      <p style={{
        ...
        This Next.js starter is deployed and running on your own VPS.
        Edit <code style={{ background: 'rgba(255,255,255,0.08)', padding: '2px 8px', borderRadius: '4px', fontSize: '0.9em', color: 'rgba(255,255,255,0.7)' }}>app/page.tsx</code> to get started.
      </p>
      ...
      <a
        ...
        style={{
          ...
          color: '#a5b4fc', borderRadius: '12px', padding: '14px 28px',
          textDecoration: 'none', fontSize: '15px', fontWeight: 600,
          transition: 'all 0.2s',
        }}
        onMouseEnter={e => {
          (e.currentTarget as HTMLAnchorElement).style.background = 'rgba(99,102,241,0.25)';
          (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(99,102,241,0.7)';
        }}
        onMouseLeave={e => {
